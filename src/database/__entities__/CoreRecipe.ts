 ...
 *
 * This file, 'CoreRecipe.ts', is generated automatically from the source database schema (DBML).
...
abstract class CoreRecipe {
  ...
  @Column({ name: 'dishId', type: 'uuid', nullable: true })
  dishId: string
}
